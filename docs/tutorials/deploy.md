...
1.  When you initialize your app, you will be prompted for 
    ...
    Configure and deploy Firebase hosting sites. Directory to 
    use as the public root (default is "public"). Enter `build`. 
    Which contains everything your application needs to run.
